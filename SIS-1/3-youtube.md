...
1. Response time less than 200ms, for distinct regions less than 1000ms
...
8. We also need RAM that can read/write 3TB/second. DDR5 can read/write around 64 GB/s. We need 3 * 10^12 / 64 * 10^9 = 46875 RAM modules, where every module can store 64 GB. (3PB os RAM?)
9. Replication of data. 3 copies of data should be stored
